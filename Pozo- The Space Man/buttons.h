	...
	void render(int button) { // 1(play), 2(help), 3(options), 4(back), 5(exit), 6(menu), 7(volumeP), 8(volumeM), 9(difficultyP), 10(difficultyM)
		if(!Buttons::hover) {
			if(button == 1)
				...
				al_draw_text(Buttons::font, al_map_rgb(counter185r,counter185g,counter185b), Buttons::x, Buttons::y, 1, "HELP");
			else if(button == 3)
				al_draw_text(Buttons::font, al_map_rgb(counter185r,counter185g,counter185b), Buttons::x, Buttons::y, 1, "OPTN");
			else if(button == 4)
				al_draw_text(Buttons::font, al_map_rgb(counter185r,counter185g,counter185b), Buttons::x, Buttons::y, 1, "BACK");
			else if(button == 5)
				al_draw_text(Buttons::font, al_map_rgb(counter185r,counter185g,counter185b), Buttons::x, Buttons::y, 1, "EXIT");
			else if(button == 6)
				al_draw_text(Buttons::font, al_map_rgb(counter185r,counter185g,counter185b), Buttons::x, Buttons::y, 1, "MENU");
			else if(button == 7)
				al_draw_text(Buttons::font, al_map_rgb(counter185r,counter185g,counter185b), Buttons::x, Buttons::y, 1, "+");
			else if(button == 8)
				al_draw_text(Buttons::font, al_map_rgb(counter185r,counter185g,counter185b), Buttons::x, Buttons::y, 1, "-");
			else if(button == 9)
				al_draw_text(Buttons::font, al_map_rgb(counter185r,counter185g,counter185b), Buttons::x, Buttons::y, 1, "+");
			...
			if(button == 1)
				...
				al_draw_text(Buttons::font, al_map_rgb(255,255,255), Buttons::x, Buttons::y, 1, "HELP");
			else if(button == 3)
				al_draw_text(Buttons::font, al_map_rgb(255,255,255), Buttons::x, Buttons::y, 1, "OPTN");
			else if(button == 4)
				al_draw_text(Buttons::font, al_map_rgb(255,255,255), Buttons::x, Buttons::y, 1, "BACK");
			else if(button == 5)
				al_draw_text(Buttons::font, al_map_rgb(255,255,255), Buttons::x, Buttons::y, 1, "EXIT");
			else if(button == 6)
				al_draw_text(Buttons::font, al_map_rgb(255,255,255), Buttons::x, Buttons::y, 1, "MENU");
			else if(button == 7)
				al_draw_text(Buttons::font, al_map_rgb(255,255,255), Buttons::x, Buttons::y, 1, "+");
			else if(button == 8)
				al_draw_text(Buttons::font, al_map_rgb(255,255,255), Buttons::x, Buttons::y, 1, "-");
			else if(button == 9)
				al_draw_text(Buttons::font, al_map_rgb(255,255,255), Buttons::x, Buttons::y, 1, "+");
